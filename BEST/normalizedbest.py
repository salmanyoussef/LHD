# W_BEST_LINE simplified version with terminal output
...
def main():
    ap = argparse.ArgumentParser(description="W_BEST_LINE mapping tool (terminal output)")
    ap.add_argument("old_file", type=Path)
    ap.add_argument("new_file", type=Path)
    ap.add_argument("--out", type=Path, default=None, help="Optional output file")
